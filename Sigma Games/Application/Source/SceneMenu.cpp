...
void SceneMenu::Init()
{
	...
	camera.Init(glm::vec3(0, 2, 15), glm::vec3(1, 2, 0), glm::vec3(0, 1, 0));
...
void SceneMenu::RenderText(Mesh* mesh, std::string text, glm::vec3 color)
{
...
void SceneMenu::RenderTextOnScreen(Mesh* mesh, std::string text, glm::vec3 color, float size, float x, float y)
{
	if (!mesh || mesh->textureID <= 0) //Proper error check
		return;
	// Enable blending
