...
void SceneMenu::Init()
{
	...
	/*meshList[GEO_DOOR] = MeshBuilder::GenerateQuad("Soor", glm::vec3(1.f, 1.f, 1.f), 1.f);*/
	...
	door.pos = glm::vec3{46,5,40};

	dartsdoor.dimension = glm::vec3{ 4,4,4 };
	dartsdoor.pos = glm::vec3(46,5, -35);

	bankaball.dimension = glm::vec3{ 4,4,4 };
	bankaball.pos = glm::vec3(-46, 5, 35);


	ringtossball.dimension = glm::vec3{ 4,4,4 };
	ringtossball.pos = glm::vec3(-46, 5, -40);

	prizedoor.dimension = glm::vec3{ 4,4,4 };
	prizedoor.pos = glm::vec3(0, 5, 0);
